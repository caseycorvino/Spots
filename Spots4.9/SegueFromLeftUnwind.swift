...
class SegueFromLeftUnnwind: UIStoryboardSegue {
    ...
    override func perform() {
        ...
        secondVCView?.frame = CGRect.init(x: screenWidth, y: 0.0, width: screenWidth, height: screenHeight);
